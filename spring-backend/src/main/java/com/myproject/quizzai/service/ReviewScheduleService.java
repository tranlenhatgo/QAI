...
public class ReviewScheduleService {
    ...
    private ReviewScheduleResponseDto toResponse(ReviewSchedule s) {
        return ReviewScheduleResponseDto.builder()
                ...
                .next_review(s.getNext_review() != null ? s.getNext_review().toString() : null)
                .last_reviewed(s.getLast_reviewed() != null ? s.getLast_reviewed().toString() : null)
                .last_score(s.getLast_score())
                .updated_at(s.getUpdated_at() != null ? s.getUpdated_at().toString() : null)
                .build();
    }
