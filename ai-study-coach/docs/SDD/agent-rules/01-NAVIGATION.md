...
1. **Label protocol is NOT function calling** — DeepTutor uses text labels (FINISH/TOOL/THINK/PAUSE) parsed from LLM output. The Study Coach uses native function calling (DeepSeek, OpenAI-compatible) instead.
