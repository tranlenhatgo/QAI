...
| -------- | ---------------------- | ----------- |
| `core/agentic/` | `server/capabilities/agentic.py` | HIGH — the agentic loop |
| `core/tool_protocol.py` | `server/tools/base.py` | HIGH — tool interface |
| `core/stream.py` | WS protocol events | MEDIUM — event types |
| `capabilities/chat/` | `server/capabilities/chat.py` | HIGH — chat impl |
| `capabilities/deep_solve/` | `server/capabilities/solve.py` | HIGH — solving |
| `capabilities/deep_question/` | `server/capabilities/quiz.py` | HIGH — quiz gen |
| `tools/builtin/rag.py` | `server/tools/rag.py` | HIGH — RAG tool |
| `tools/builtin/reason.py` | `server/tools/reason.py` | HIGH — reason tool |
| `services/llm_service.py` | `server/llm/base.py` | HIGH — LLM abstraction |
| `services/providers/` | `server/llm/lm_studio.py`, `deepseek.py` | MEDIUM — provider impl |
| `api/routers/unified_ws.py` | `server/ws/endpoint.py` | MEDIUM — WS handler |
| `config/` | `server/config.py` | LOW — different approach |
| `knowledge/` | `server/services/supabase_client.py` | MEDIUM — RAG infra |
