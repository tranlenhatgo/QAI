...
**Key insight**: Don't invent a custom state format. Use the standard `messages[]` array that maps directly to the OpenAI/DeepSeek API format.
...
| Label-based text protocol parsing | Native function calling (DeepSeek) |
