...
- [ ] Works with Gemini provider (Full mode)
...
- `ai_coach/llm/base.py` — LLMService, Message, StreamChunk
- `ai_coach/services/supabase_client.py` — RAG search (optional, for KB-enabled chat)
