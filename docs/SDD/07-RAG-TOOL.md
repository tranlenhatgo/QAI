...
from ai_coach.services.supabase_client import SupabaseClient
from ai_coach.services.embeddings import EmbeddingService
...
```python
# ai_coach/services/embeddings.py
...
```python
# ai_coach/services/supabase_client.py
...
```python
# ai_coach/services/ingestion.py
