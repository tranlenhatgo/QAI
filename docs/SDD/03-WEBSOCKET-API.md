...
```python
# ai_coach/ws/endpoint.py

from fastapi import WebSocket, WebSocketDisconnect
from ai_coach.config import AppConfig
from ai_coach.router import resolve_capability, Tier, Mode
from ai_coach.ws.protocol import *
from ai_coach.ws.session import Session
import json
...
class Session:
    ...
    def switch_mode(self, new_mode):
        from ai_coach.router import resolve_capability
        self.mode = new_mode
...
// Error
{"type": "error", "code": "rate_limit", "message": "Gemini rate limit exceeded. Retry in 60s."}
