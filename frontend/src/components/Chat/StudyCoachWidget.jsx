...
export default function StudyCoachWidget() {
	...
	return (
		<div
			className={`fixed bottom-16 right-4 z-[60] origin-bottom-right w-[min(24rem,calc(100vw-1.5rem))] overflow-hidden rounded-[1.5rem] border border-blue-700/50 bg-slate-200 text-slate-100 shadow-[0_28px_80px_rgba(15,23,42,0.5)] transition-all duration-300 md:right-6 ${isOpen ? 'pointer-events-auto translate-y-0 scale-100 opacity-100' : 'pointer-events-none translate-y-3 scale-95 opacity-0'
				}`}
		>
			...
			<div className="max-h-[min(32rem,calc(100vh-11rem))] overflow-y-auto px-4 py-4">
				<ChatTranscript
					messages={messages}
